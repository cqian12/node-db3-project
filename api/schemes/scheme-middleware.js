...
const checkSchemeId = async (req, res, next) => {
  ...
  try {
    ...
    if (!scheme) { //put below into next() if it doesn't work this way
...
const validateStep = (req, res, next) => {
  ...
  if (instructions === undefined || !instructions || instructions.trim() === '' || typeof instructions !== 'string'
  || !step_number || step_number < 1 || typeof step_number !== 'number') {
